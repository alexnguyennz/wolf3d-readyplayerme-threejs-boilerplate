...
import MorphTargetAnimator from "../helpers/MorphTargetAnimator.js";
import CursorTracker from "../helpers/CursorTracker.js";
import { AvatarSettings as avatarSettings } from "../config.js";
...
export class Avatar extends Object3D {
  ...
  init(renderer) {
    ...
    if (this.model.Wolf3D_Avatar) {
      this.headMesh = this.model.Wolf3D_Avatar;
    } else {
      this.headMesh = this.model;
    }
